...
pacman -Syyuu --noconfirm base-devel git rust whois cmake extra-cmake-modules qt6-base qt6-tools kf6 libkscreen plasma-workspace kdeplasma-addons plasma-desktop
pacman -S --clean
